...
Hvis du hurtigt skal finde noget:

- IP/subnetting: `01-ip-subnetting.md`
- ARP/switch/STP: `02-switch-arp-stp.md`
- Routing/SRX: `03-routing-og-srx.md`
- DHCP/DNS/NAT: `04-dhcp-dns-nat.md`
- Wireshark: `05-wireshark-og-fejlfinding.md`
- MQTT/SSH: `06-mqtt-ssh.md`
